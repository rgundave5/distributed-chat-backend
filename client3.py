...
def main():
    ...
    # test signup
    # multiple clients
    client1_signup_response = signup("joedoe9@gmail.com", "junk123")
    client2_signup_response = signup("rose1@gmail.com", "pword")

    # test correct and incorrect login attempts
    if client1_signup_response.get("message") == "Data stored successfully":
        login("joedoe9@gmail.com", "junk123")  # correct
        login("joedoe9@gmail.com", "wrongpass")  # incorrect
    
    if client2_signup_response.get("message") == "Data stored successfully":
        login("rose1@gmail.com", "pword")  # correct
        login("rose1@gmail.com", "wrongpass")  # incorrect
